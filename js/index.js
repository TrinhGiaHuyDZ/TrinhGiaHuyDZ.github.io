...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://t.me/Ngducchung', '_blank');
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://github.com/TrGiaHuy76', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Facebook');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/Zukishihiro', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Instagram');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.instagram.com/trgiahuy76/?hl=en', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Tiktok');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.tiktok.com/@trinhhuy41', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Youtube');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.youtube.com/channel/UCbUqQqcEd3GWz673RNerIaQ', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Zalo');
    telegramDiv.addEventListener('click', function () {
        window.open('https://zalo.me/0364831736', '_blank');
    });
});
...
console.log('%c- Có vẻ như bạn đang cố tình ăn cắp mã nguồn của tôi </ NgDucChung >.', 'color: #444; font-size: 25px; font-family: sans-serif;');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var audio = new Audio('./audio/giahuy.mp3');
...
welcomeText.textContent = "Designed By Trịnh Gia Huy Đẹp Trai =))";
